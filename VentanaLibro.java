...
public class VentanaLibro extends JFrame {
    ...
    private JPanel panel2;//tabla para mostrar libro
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(235));
        lblId= new JLabel("id: ");
        ...
        panel2.setBackground(new Color(235));
        ...
        panel3.setBackground(new Color(235));



        //panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(235));
